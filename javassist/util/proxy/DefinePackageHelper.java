...
public class DefinePackageHelper
{
    ...
    private static class Java7 extends Helper
    {
        ...
        private MethodHandle getDefinePackageMethodHandle() {
            ...
            try {
                return SecurityActions.getMethodHandle((Class)ClassLoader.class, "definePackage", new Class[] { String.class, String.class, String.class, String.class, String.class, String.class, String.class, URL.class });
            }
    ...
    private static class JavaOther extends Helper
    {
        ...
        private Method getDefinePackageMethod() {
            ...
            try {
                return SecurityActions.getDeclaredMethod((Class)ClassLoader.class, "definePackage", new Class[] { String.class, String.class, String.class, String.class, String.class, String.class, String.class, URL.class });
            }
            catch (NoSuchMethodException e) {
                throw new RuntimeException("cannot initialize", e);
            }

...
class SerializedProxy implements Serializable
{
    ...
    Object readResolve() throws ObjectStreamException {
        try {
            ...
            f.setSuperclass((Class)this.loadClass(this.superClass));
            f.setInterfaces((Class[])infs);
            final Proxy proxy = f.createClass(this.filterSignature).getConstructor((Class<?>[])new Class[0]).newInstance(new Object[0]);

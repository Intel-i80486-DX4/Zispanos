...
public class ScopedClassPool extends ClassPool
{
    ...
    protected ScopedClassPool(final ClassLoader cl, final ClassPool src, final ScopedClassPoolRepository repository, final boolean isTemp) {
        super(src);
        this.softcache = (Map<String, CtClass>)new SoftValueHashMap();
    ...
    protected CtClass getCached(final String classname) {
        ...
        if (clazz == null) {
            ...
            if (!isLocal) {
                final Map<ClassLoader, ScopedClassPool> registeredCLs = (Map<ClassLoader, ScopedClassPool>)this.repository.getRegisteredCLs();

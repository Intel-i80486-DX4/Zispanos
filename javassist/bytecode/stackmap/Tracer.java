...
public abstract class Tracer implements TypeTag
{
    ...
    private int doOpcode0_53(final int pos, final byte[] code, final int op) throws BadBytecode {
        ...
        switch (op) {
            ...
            case 1: {
                stackTypes[this.stackTop++] = (TypeData)new TypeData.NullType();
                break;
            }
            case 2:
            case 3:
            ...
            case 7:
            case 8: {
                stackTypes[this.stackTop++] = (TypeData)Tracer.INTEGER;
                break;
            }
            case 9:
            case 10: {
                stackTypes[this.stackTop++] = (TypeData)Tracer.LONG;
                stackTypes[this.stackTop++] = (TypeData)Tracer.TOP;
                break;
            }
            case 11:
            case 12:
            case 13: {
                stackTypes[this.stackTop++] = (TypeData)Tracer.FLOAT;
                break;
            }
            case 14:
            case 15: {
                stackTypes[this.stackTop++] = (TypeData)Tracer.DOUBLE;
                stackTypes[this.stackTop++] = (TypeData)Tracer.TOP;
                break;
            }
            case 16:
            ...
            case 21: {
                return this.doXLOAD((TypeData)Tracer.INTEGER, code, pos);
            }
            case 22: {
                return this.doXLOAD((TypeData)Tracer.LONG, code, pos);
            }
            case 23: {
                return this.doXLOAD((TypeData)Tracer.FLOAT, code, pos);
            }
            case 24: {
                return this.doXLOAD((TypeData)Tracer.DOUBLE, code, pos);
            }
            case 25: {
            ...
            case 46: {
                ...
                array[stackTop - 1] = (TypeData)Tracer.INTEGER;
                break;
            }
            case 47: {
                stackTypes[this.stackTop - 2] = (TypeData)Tracer.LONG;
                stackTypes[this.stackTop - 1] = (TypeData)Tracer.TOP;
                break;
            }
            case 48: {
                ...
                array2[stackTop2 - 1] = (TypeData)Tracer.FLOAT;
                break;
            }
            case 49: {
                stackTypes[this.stackTop - 2] = (TypeData)Tracer.DOUBLE;
                stackTypes[this.stackTop - 1] = (TypeData)Tracer.TOP;
                break;
            }
            case 50: {
            ...
            case 53: {
                ...
                array3[stackTop4 - 1] = (TypeData)Tracer.INTEGER;
                break;
            }
            default: {
    ...
    private void doLDC(final int index) {
        ...
        if (tag == 8) {
            stackTypes[this.stackTop++] = (TypeData)new TypeData.ClassName("java.lang.String");
        }
        else if (tag == 3) {
            stackTypes[this.stackTop++] = (TypeData)Tracer.INTEGER;
        }
            ...
            stackTypes[this.stackTop++] = (TypeData)new TypeData.ClassName("java.lang.Class");
        }
    }
    ...
    private int doXLOAD(final int localVar, final TypeData type) {
        ...
        if (type.is2WordType()) {
            this.stackTypes[this.stackTop++] = (TypeData)Tracer.TOP;
        }
        return 2;
    }
    ...
    private int doOpcode54_95(final int pos, final byte[] code, final int op) throws BadBytecode {
        switch (op) {
            case 54: {
                return this.doXSTORE(pos, code, (TypeData)Tracer.INTEGER);
            }
            case 55: {
                return this.doXSTORE(pos, code, (TypeData)Tracer.LONG);
            }
            case 56: {
                return this.doXSTORE(pos, code, (TypeData)Tracer.FLOAT);
            }
            case 57: {
                return this.doXSTORE(pos, code, (TypeData)Tracer.DOUBLE);
            }
            case 58: {
            ...
            case 62: {
                final int var = op - 59;
                this.localsTypes[var] = (TypeData)Tracer.INTEGER;
                --this.stackTop;
                break;
            }
            case 63:
            ...
            case 66: {
                final int var = op - 63;
                this.localsTypes[var] = (TypeData)Tracer.LONG;
                this.localsTypes[var + 1] = (TypeData)Tracer.TOP;
                this.stackTop -= 2;
                break;
            }
            case 67:
            ...
            case 70: {
                final int var = op - 67;
                this.localsTypes[var] = (TypeData)Tracer.FLOAT;
                --this.stackTop;
                break;
            }
            case 71:
            ...
            case 74: {
                final int var = op - 71;
                this.localsTypes[var] = (TypeData)Tracer.DOUBLE;
                this.localsTypes[var + 1] = (TypeData)Tracer.TOP;
                this.stackTop -= 2;
                break;
            }
    ...
    private int doXSTORE(final int index, final TypeData type) {
        ...
        if (type.is2WordType()) {
            --this.stackTop;
            this.localsTypes[index + 1] = (TypeData)Tracer.TOP;
        }
        return 2;
    }
    ...
    private int doOpcode96_147(final int pos, final byte[] code, final int op) {
        ...
        switch (op) {
            ...
            case 133: {
                this.stackTypes[this.stackTop - 1] = (TypeData)Tracer.LONG;
                this.stackTypes[this.stackTop] = (TypeData)Tracer.TOP;
                ++this.stackTop;
                break;
            }
            case 134: {
                this.stackTypes[this.stackTop - 1] = (TypeData)Tracer.FLOAT;
                break;
            }
            case 135: {
                this.stackTypes[this.stackTop - 1] = (TypeData)Tracer.DOUBLE;
                this.stackTypes[this.stackTop] = (TypeData)Tracer.TOP;
                ++this.stackTop;
                break;
            }
            case 136: {
                ...
                final int stackTop = this.stackTop - 1;
                this.stackTop = stackTop;
                stackTypes[stackTop - 1] = (TypeData)Tracer.INTEGER;
                break;
            }
            case 137: {
                ...
                final int stackTop2 = this.stackTop - 1;
                this.stackTop = stackTop2;
                stackTypes2[stackTop2 - 1] = (TypeData)Tracer.FLOAT;
                break;
            }
            case 138: {
                this.stackTypes[this.stackTop - 2] = (TypeData)Tracer.DOUBLE;
                break;
            }
            case 139: {
                this.stackTypes[this.stackTop - 1] = (TypeData)Tracer.INTEGER;
                break;
            }
            case 140: {
                this.stackTypes[this.stackTop - 1] = (TypeData)Tracer.LONG;
            ...
            case 142: {
                ...
                final int stackTop3 = this.stackTop - 1;
                this.stackTop = stackTop3;
                stackTypes3[stackTop3 - 1] = (TypeData)Tracer.INTEGER;
                break;
            }
            case 143: {
                this.stackTypes[this.stackTop - 2] = (TypeData)Tracer.LONG;
                break;
            }
            case 144: {
                ...
                final int stackTop4 = this.stackTop - 1;
                this.stackTop = stackTop4;
                stackTypes4[stackTop4 - 1] = (TypeData)Tracer.FLOAT;
                break;
            }
            case 145:
            case 146:
    ...
    private int doOpcode148_201(final int pos, final byte[] code, final int op) throws BadBytecode {
        switch (op) {
            case 148: {
                this.stackTypes[this.stackTop - 4] = (TypeData)Tracer.INTEGER;
                this.stackTop -= 3;
                break;
            }
            case 149:
            ...
            case 187: {
                ...
                this.stackTypes[this.stackTop++] = (TypeData)new TypeData.UninitData(pos, this.cpool.getClassInfo(i));
                return 3;
            }
            case 188: {
            ...
            case 189: {
                ...
                this.stackTypes[this.stackTop - 1] = (TypeData)new TypeData.ClassName(type);
                return 3;
            }
            case 190: {
    ...
    private int doWIDE(final int pos, final byte[] code) throws BadBytecode {
        ...
        switch (op) {
            case 21: {
                this.doWIDE_XLOAD(pos, code, (TypeData)Tracer.INTEGER);
                break;
            }
            case 22: {
                this.doWIDE_XLOAD(pos, code, (TypeData)Tracer.LONG);
                break;
            }
            case 23: {
                this.doWIDE_XLOAD(pos, code, (TypeData)Tracer.FLOAT);
                break;
            }
            case 24: {
                this.doWIDE_XLOAD(pos, code, (TypeData)Tracer.DOUBLE);
                break;
            }
            case 25: {
            ...
            case 54: {
                this.doWIDE_STORE(pos, code, (TypeData)Tracer.INTEGER);
                break;
            }
            case 55: {
                this.doWIDE_STORE(pos, code, (TypeData)Tracer.LONG);
                break;
            }
            case 56: {
                this.doWIDE_STORE(pos, code, (TypeData)Tracer.FLOAT);
                break;
            }
            case 57: {
                this.doWIDE_STORE(pos, code, (TypeData)Tracer.DOUBLE);
                break;
            }
            case 58: {
                final int index = ByteArray.readU16bit(code, pos + 2);
    ...
    private int doNEWARRAY(final int pos, final byte[] code) {
        ...
        this.stackTypes[s] = (TypeData)new TypeData.ClassName(type);
        return 2;
    }
    ...
    private void pushMemberType(final String descriptor) {
        ...
        switch (descriptor.charAt(top)) {
            case '[': {
                types[index] = (TypeData)new TypeData.ClassName(descriptor.substring(top));
                break;
            }
            case 'L': {
                types[index] = (TypeData)new TypeData.ClassName(getFieldClassName(descriptor, top));
                break;
            }
            case 'J': {
                types[index] = (TypeData)Tracer.LONG;
                types[index + 1] = (TypeData)Tracer.TOP;
                this.stackTop += 2;
                return;
            }
            case 'F': {
                types[index] = (TypeData)Tracer.FLOAT;
                break;
            }
            case 'D': {
                types[index] = (TypeData)Tracer.DOUBLE;
                types[index + 1] = (TypeData)Tracer.TOP;
                this.stackTop += 2;
                return;
            }
            ...
            default: {
                types[index] = (TypeData)Tracer.INTEGER;
                break;
            }
        }
        ++this.stackTop;

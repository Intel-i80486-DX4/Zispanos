...
public class MethodInfo
{
    ...
    void compact(final ConstPool cp) {
        ...
        this.attribute = (List<AttributeInfo>)AttributeInfo.copyAll((List)this.attribute, cp);
        this.constPool = cp;
    }
    ...
    public AttributeInfo getAttribute(final String name) {
        return AttributeInfo.lookup((List)this.attribute, name);
    }
    
    public AttributeInfo removeAttribute(final String name) {
        return AttributeInfo.remove((List)this.attribute, name);
    }
    ...
    public void addAttribute(final AttributeInfo info) {
        ...
        AttributeInfo.remove((List)this.attribute, info.getName());
        this.attribute.add(info);
    }
    
    public ExceptionsAttribute getExceptionsAttribute() {
        final AttributeInfo info = AttributeInfo.lookup((List)this.attribute, "Exceptions");
        return (ExceptionsAttribute)info;
    }
    
    public CodeAttribute getCodeAttribute() {
        final AttributeInfo info = AttributeInfo.lookup((List)this.attribute, "Code");
        return (CodeAttribute)info;
    }
    
    public void removeExceptionsAttribute() {
        AttributeInfo.remove((List)this.attribute, "Exceptions");
    }
    ...
    public void removeCodeAttribute() {
        AttributeInfo.remove((List)this.attribute, "Code");
    }
    ...
    public void setCodeAttribute(final CodeAttribute cattr) {
        ...
        this.attribute.add((AttributeInfo)cattr);
    }
    ...
    private void read(final MethodInfo src, final String methodname, final Map<String, String> classnames) {
        ...
        if (cattr != null) {
            this.attribute.add(cattr.copy(destCp, (Map)classnames));
        }
    }
    ...
    void write(final DataOutputStream out) throws IOException {
        ...
        if (this.attribute == null) {
            ...
            AttributeInfo.writeAll((List)this.attribute, out);
        }
    }

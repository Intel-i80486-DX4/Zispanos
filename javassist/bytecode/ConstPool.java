...
public final class ConstPool
{
    ...
    public int addFieldrefInfo(final int classInfo, final int nameAndTypeInfo) {
        return this.addItem((ConstInfo)new FieldrefInfo(classInfo, nameAndTypeInfo, this.numOfItems));
    }
    ...
    public int addStringInfo(final String str) {
        ...
        return this.addItem((ConstInfo)new StringInfo(utf, this.numOfItems));
    }
    ...
    public int addMethodTypeInfo(final int desc) {
        return this.addItem((ConstInfo)new MethodTypeInfo(desc, this.numOfItems));
    }
    ...
    public int addDynamicInfo(final int bootstrap, final int nameAndType) {
        return this.addItem((ConstInfo)new DynamicInfo(bootstrap, nameAndType, this.numOfItems));
    }
    ...
    public int addPackageInfo(final int nameIndex) {
        return this.addItem((ConstInfo)new PackageInfo(nameIndex, this.numOfItems));
    }
    ...
    private int readOne(final DataInputStream in) throws IOException {
        ...
        switch (tag) {
            ...
            case 8: {
                info = (ConstInfo)new StringInfo(in, this.numOfItems);
                break;
            }
            case 9: {
                info = (ConstInfo)new FieldrefInfo(in, this.numOfItems);
                break;
            }
            case 10: {
            ...
            case 16: {
                info = (ConstInfo)new MethodTypeInfo(in, this.numOfItems);
                break;
            }
            case 17: {
                info = (ConstInfo)new DynamicInfo(in, this.numOfItems);
                break;
            }
            case 18: {
            ...
            case 20: {
                info = (ConstInfo)new PackageInfo(in, this.numOfItems);
                break;
            }
            default: {

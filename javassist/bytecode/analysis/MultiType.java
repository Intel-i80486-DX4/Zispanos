...
public class MultiType extends Type
{
    ...
    private Map<String, CtClass> mergeMultiInterfaces(final MultiType type1, final MultiType type2) {
        ...
        return (Map<String, CtClass>)this.findCommonInterfaces((Map)map1, (Map)map2);
    }
    ...
    private Map<String, CtClass> mergeMultiAndSingle(final MultiType multi, final Type single) {
        ...
        final Map<String, CtClass> map2 = (Map<String, CtClass>)this.getAllInterfaces(single.getCtClass(), (Map)null);
        return (Map<String, CtClass>)this.findCommonInterfaces((Map)map1, (Map)map2);
    }
    ...
    public Type merge(final Type type) {
        ...
        if (this.potentialClass != null) {
            ...
            if (!mergePotential.equals((Object)this.potentialClass) || mergePotential.popChanged()) {
                this.potentialClass = (Type.OBJECT.equals((Object)mergePotential) ? null : mergePotential);
                this.changed = true;
            }
        }
    ...
    public boolean equals(final Object o) {
        ...
        if (this.resolved != null) {
            return this.resolved.equals((Object)multi.resolved);
        }

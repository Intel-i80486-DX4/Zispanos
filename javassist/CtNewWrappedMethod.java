...
class CtNewWrappedMethod
{
    ...
    private static String addBodyMethod(final CtClassType clazz, final ClassFile classfile, final CtMethod src) throws BadBytecode, CannotCompileException {
        final Map<CtMethod, String> bodies = (Map<CtMethod, String>)clazz.getHiddenMethods();
        ...
        if (bodyname == null) {
            ...
            final MethodInfo body = new MethodInfo(classfile.getConstPool(), bodyname, src.getMethodInfo2(), (Map<String, String>)map);

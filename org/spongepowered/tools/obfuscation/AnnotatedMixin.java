...
class AnnotatedMixin
{
    ...
    public void registerInvoker(final ExecutableElement element, final AnnotationHandle invoker, final boolean shouldRemap) {
        this.methods.remove(element);
        this.accessors.registerAccessor((AnnotatedMixinElementHandlerAccessor.AnnotatedElementAccessor)new AnnotatedMixinElementHandlerAccessor.AnnotatedElementInvoker(element, invoker, shouldRemap));
    }

...
public abstract class InjectionPoint
{
    ...
    public static InjectionPoint parse(final IMixinContext context, final MethodNode method, final AnnotationNode parent, final AnnotationNode node) {
        final String at = (String)Annotations.getValue(node, "value");
        List<String> args = (List<String>)Annotations.getValue(node, "args");
        final String target = (String)Annotations.getValue(node, "target", (Object)"");
        final String slice = (String)Annotations.getValue(node, "slice", (Object)"");
        final At.Shift shift = (At.Shift)Annotations.getValue(node, "shift", (Class)At.Shift.class, (Enum)At.Shift.NONE);
        final int by = (int)Annotations.getValue(node, "by", (Object)0);
        final int ordinal = (int)Annotations.getValue(node, "ordinal", (Object)(-1));
        final int opcode = (int)Annotations.getValue(node, "opcode", (Object)0);
        final String id = (String)Annotations.getValue(node, "id");
        if (args == null) {
    ...
    static {
        ...
        register((Class<? extends InjectionPoint>)BeforeLoadLocal.class);
        register((Class<? extends InjectionPoint>)AfterStoreLocal.class);

...
public class LocalVariableDiscriminator
{
    ...
    public static LocalVariableDiscriminator parse(final AnnotationNode annotation) {
        final boolean argsOnly = (boolean)Annotations.getValue(annotation, "argsOnly", (Object)Boolean.FALSE);
        final int ordinal = (int)Annotations.getValue(annotation, "ordinal", (Object)(-1));
        final int index = (int)Annotations.getValue(annotation, "index", (Object)(-1));
        final boolean print = (boolean)Annotations.getValue(annotation, "print", (Object)Boolean.FALSE);
        final Set<String> names = new HashSet<String>();
        final List<String> namesList = (List<String>)Annotations.getValue(annotation, "name", (Object)null);
        if (namesList != null) {
        ...
        public void print(final PrettyPrinter printer) {
            ...
            for (int l = this.baseArgIndex; l < this.locals.length; ++l) {
                ...
                if (local != null) {
                    ...
                    printer.add("[%3d]    [%3d]  %30s  %-50s  %s", new Object[] { l, ordinal, SignaturePrinter.getTypeName(localType, false), localName, candidate });
                }
                else if (l > 0) {
                    final Local prevLocal = this.locals[l - 1];
                    final boolean isTop = prevLocal != null && prevLocal.type != null && prevLocal.type.getSize() > 1;
                    printer.add("[%3d]           %30s", new Object[] { l, isTop ? "<top>" : "-" });
                }
            }
        }

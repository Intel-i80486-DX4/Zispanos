...
public class BeforeConstant extends InjectionPoint
{
    ...
    public BeforeConstant(final IMixinContext context, final AnnotationNode node, final String returnType) {
        ...
        final Boolean empty = (Boolean)Annotations.getValue(node, "nullValue", (Object)null);
        this.ordinal = (int)Annotations.getValue(node, "ordinal", (Object)(-1));
        this.nullValue = (empty != null && empty);
        this.intValue = (Integer)Annotations.getValue(node, "intValue", (Object)null);
        this.floatValue = (Float)Annotations.getValue(node, "floatValue", (Object)null);
        this.longValue = (Long)Annotations.getValue(node, "longValue", (Object)null);
        this.doubleValue = (Double)Annotations.getValue(node, "doubleValue", (Object)null);
        this.stringValue = (String)Annotations.getValue(node, "stringValue", (Object)null);
        this.typeValue = (Type)Annotations.getValue(node, "classValue", (Object)null);
        this.matchByType = this.validateDiscriminator(context, returnType, empty, "on @Constant annotation");
        this.expandOpcodes = this.parseExpandOpcodes(Annotations.getValue(node, "expandZeroConditions", true, (Class)Constant.Condition.class));
    ...
    public BeforeConstant(final InjectionPointData data) {
        super(data);
        final String strNullValue = data.get("nullValue", (String)null);
        ...
        final String strClassValue = data.get("classValue", (String)null);

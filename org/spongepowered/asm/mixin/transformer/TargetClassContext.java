...
class TargetClassContext extends ClassContext implements ITargetClassContext
{
    ...
    void processDebugTasks() {
        ...
        final AnnotationNode classDebugAnnotation = Annotations.getVisible(this.classNode, (Class)Debug.class);
        ...
        for (final MethodNode method : this.classNode.methods) {
            final AnnotationNode methodDebugAnnotation = Annotations.getVisible(method, (Class)Debug.class);

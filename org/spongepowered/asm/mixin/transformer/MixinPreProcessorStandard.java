...
class MixinPreProcessorStandard
{
    ...
    protected void prepareShadow(final MixinInfo.MixinMethodNode mixinMethod, final ClassInfo.Method method) {
        final AnnotationNode shadowAnnotation = Annotations.getVisible((MethodNode)mixinMethod, (Class)Shadow.class);
        if (shadowAnnotation == null) {
            return;
        }
        final String prefix = (String)Annotations.getValue(shadowAnnotation, "prefix", (Class)Shadow.class);
        if (mixinMethod.name.startsWith(prefix)) {
            Annotations.setVisible((MethodNode)mixinMethod, (Class)MixinRenamed.class, new Object[] { "originalName", mixinMethod.name });
    ...
    protected boolean attachUniqueMethod(final MixinTargetContext context, final MixinInfo.MixinMethodNode mixinMethod) {
        ...
        final AnnotationNode unique = Annotations.getVisible((MethodNode)mixinMethod, (Class)Unique.class);
    ...
    protected void attachFields(final MixinTargetContext context) {
        ...
        while (iter.hasNext()) {
            ...
            final AnnotationNode shadow = Annotations.getVisible(mixinField, (Class)Shadow.class);
    ...
    protected boolean validateField(final MixinTargetContext context, final FieldNode field, final AnnotationNode shadow) {
        ...
        final String prefix = (String)Annotations.getValue(shadow, "prefix", (Class)Shadow.class);
    ...
    protected static String getDynamicInfo(final MethodNode method) {
        return getDynamicInfo("Method", Annotations.getInvisible(method, (Class)Dynamic.class));
    }
    
    protected static String getDynamicInfo(final FieldNode method) {
        return getDynamicInfo("Field", Annotations.getInvisible(method, (Class)Dynamic.class));
    }
    ...
    enum SpecialMethod
    {
        ...
        private SpecialMethod(final boolean isOverwrite, final Class<? extends Annotation> type) {
            ...
            this.description = "@" + Bytecode.getSimpleName((Class)type);
        }

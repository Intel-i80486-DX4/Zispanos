...
class MixinInfo implements Comparable<MixinInfo>, IMixinInfo
{
    ...
    protected List<ClassInfo> readTargetClasses(final MixinClassNode classNode, final boolean suppressPlugin) {
        ...
        final AnnotationNode mixin = Annotations.getInvisible((ClassNode)classNode, (Class)Mixin.class);
        if (mixin == null) {
        ...
        final List<Type> publicTargets = (List<Type>)Annotations.getValue(mixin, "value");
        final List<String> privateTargets = (List<String>)Annotations.getValue(mixin, "targets");
    ...
    protected int readPriority(final ClassNode classNode) {
        ...
        final AnnotationNode mixin = Annotations.getInvisible(classNode, (Class)Mixin.class);
        if (mixin == null) {
            throw new InvalidMixinException(this, String.format("The mixin '%s' is missing an @Mixin annotation", this.className));
        }
        final Integer priority = (Integer)Annotations.getValue(mixin, "priority");
        return (priority == null) ? this.parent.getDefaultMixinPriority() : priority;
    }
    
    protected boolean readPseudo(final ClassNode classNode) {
        return Annotations.getInvisible(classNode, (Class)Pseudo.class) != null;
    }
    ...
    class MixinMethodNode extends MethodNode
    {
        ...
        public AnnotationNode getVisibleAnnotation(final Class<? extends Annotation> annotationClass) {
            return Annotations.getVisible((MethodNode)this, (Class)annotationClass);
        }
    ...
    class State
    {
        ...
        void validate(final SubType type, final List<ClassInfo> targetClasses) {
            ...
            this.unique = (Annotations.getVisible((ClassNode)this.getClassNode(), (Class)Unique.class) != null);
            this.validateInner();
        ...
        private void validateRemappables(final List<ClassInfo> targetClasses) {
            if (targetClasses.size() > 1) {
                for (final FieldNode field : this.classNode.fields) {
                    this.validateRemappable(Shadow.class, field.name, Annotations.getVisible(field, (Class)Shadow.class));
                }
                for (final MethodNode method : this.classNode.methods) {
                    this.validateRemappable(Shadow.class, method.name, Annotations.getVisible(method, (Class)Shadow.class));
                    final AnnotationNode overwrite = Annotations.getVisible(method, (Class)Overwrite.class);
        ...
        void readImplementations(final SubType type) {
            ...
            final AnnotationNode implementsAnnotation = Annotations.getInvisible((ClassNode)this.classNode, (Class)Implements.class);
            if (implementsAnnotation == null) {
                return;
            }
            final List<AnnotationNode> interfaces = (List<AnnotationNode>)Annotations.getValue(implementsAnnotation);
            if (interfaces == null) {
                return;
            }
    ...
    abstract static class SubType
    {
        ...
        static class Interface extends SubType
        {
            ...
            @Override
            MixinPreProcessorStandard createPreProcessor(final MixinClassNode classNode) {
                return (MixinPreProcessorStandard)new MixinPreProcessorInterface(this.mixin, classNode);
            }
        }
        ...
        static class Accessor extends SubType
        {
            ...
            @Override
            MixinPreProcessorStandard createPreProcessor(final MixinClassNode classNode) {
                return (MixinPreProcessorStandard)new MixinPreProcessorAccessor(this.mixin, classNode);
            }
        }
    }
}

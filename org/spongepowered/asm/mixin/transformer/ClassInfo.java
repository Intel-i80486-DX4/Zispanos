...
public final class ClassInfo
{
    ...
    public class Method extends Member
    {
        ...
        public Method(final ClassInfo this$0, final MethodNode method) {
            ...
            this.setUnique(Annotations.getVisible(method, (Class)Unique.class) != null);
    ...
    class Field extends Member
    {
        ...
        public Field(final FieldNode field, final boolean injected) {
            ...
            this.setUnique(Annotations.getVisible(field, (Class)Unique.class) != null);
            if (Annotations.getVisible(field, (Class)Shadow.class) != null) {
                final boolean decoratedFinal = Annotations.getVisible(field, (Class)Final.class) != null;
                final boolean decoratedMutable = Annotations.getVisible(field, (Class)Mutable.class) != null;

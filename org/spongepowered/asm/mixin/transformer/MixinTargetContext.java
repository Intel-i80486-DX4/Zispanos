...
public class MixinTargetContext extends ClassContext implements IMixinContext
{
    ...
    void addMixinMethod(final MethodNode method) {
        Annotations.setVisible(method, (Class)MixinMerged.class, new Object[] { "mixin", this.getClassName() });
    ...
    void methodMerged(final MethodNode method) {
        ...
        Annotations.setVisible(method, (Class)MixinMerged.class, new Object[] { "mixin", this.getClassName(), "priority", this.getPriority(), "sessionId", this.sessionId });
    }
    ...
    private void validateMethod(final MethodNode method) {
        if (Annotations.getInvisible(method, (Class)SoftOverride.class) != null) {
    ...
    MethodNode findMethod(final MethodNode method, final AnnotationNode annotation) {
        ...
        if (annotation != null) {
            final List<String> aka = (List<String>)Annotations.getValue(annotation, "aliases");
            if (aka != null) {
    ...
    FieldNode findField(final FieldNode field, final AnnotationNode shadow) {
        ...
        if (shadow != null) {
            final List<String> aka = (List<String>)Annotations.getValue(shadow, "aliases");
            if (aka != null) {
                aliases.addAll((Collection<?>)aka);
            }
        }

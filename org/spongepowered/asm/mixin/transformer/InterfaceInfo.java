...
public final class InterfaceInfo
{
    ...
    public boolean renameMethod(final MethodNode method) {
        ...
        Annotations.setVisible(method, (Class)MixinRenamed.class, new Object[] { "originalName", method.name, "isInterfaceMember", true });
        this.decorateUniqueMethod(method);
    ...
    private void decorateUniqueMethod(final MethodNode method) {
        ...
        if (Annotations.getVisible(method, (Class)Unique.class) == null) {
            Annotations.setVisible(method, (Class)Unique.class, new Object[0]);
    ...
    static InterfaceInfo fromAnnotation(final MixinInfo mixin, final AnnotationNode node) {
        final String prefix = (String)Annotations.getValue(node, "prefix");
        final Type iface = (Type)Annotations.getValue(node, "iface");
        final Boolean unique = (Boolean)Annotations.getValue(node, "unique");

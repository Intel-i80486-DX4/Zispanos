...
public class AccessorInfo extends SpecialMethodInfo
{
    ...
    protected AccessorInfo(final MixinTargetContext mixin, final MethodNode method, final Class<? extends Annotation> annotationClass) {
        super(mixin, method, Annotations.getVisible(method, (Class)annotationClass));
    ...
    protected String getTargetName() {
        final String name = (String)Annotations.getValue(this.annotation);
    ...
    protected String inflectTarget() {
        return inflectTarget(this.method.name, this.type, this.toString(), (IMixinContext)this.mixin, this.mixin.getEnvironment().getOption(MixinEnvironment.Option.DEBUG_VERBOSE));
    }

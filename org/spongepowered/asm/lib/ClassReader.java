        ...
        while (u < codeEnd) {
            ...
            switch (ClassWriter.TYPE[opcode2]) {
                ...
                case 17: {
                    opcode2 = (b[u + 1] & 0xFF);
                    if (opcode2 == 132) {
                        mv.visitIincInsn(this.readUnsignedShort(u + 2), (int)this.readShort(u + 4));
                        u += 6;
                        break;
                    }
                ...
                case 1: {
                    mv.visitIntInsn(opcode2, (int)b[u + 1]);
                    u += 2;
                    break;
                }
                case 2: {
                    mv.visitIntInsn(opcode2, (int)this.readShort(u + 1));
                    u += 3;
                    break;
                }
                case 11: {
                ...
                case 13: {
                    mv.visitIincInsn(b[u + 1] & 0xFF, (int)b[u + 2]);
                    u += 3;
                    break;
                }
                default: {

...
final class AnnotationWriter extends AnnotationVisitor
{
    ...
    public void visit(final String name, final Object value) {
        ...
        if (value instanceof String) {
            ...
            this.bv.put12(66, this.cw.newInteger((int)(byte)value).index);
        }
            ...
            this.bv.put12(67, this.cw.newInteger((int)(char)value).index);
        }
        else if (value instanceof Short) {
            this.bv.put12(83, this.cw.newInteger((int)(short)value).index);
        }
            ...
            for (int i = 0; i < v2.length; ++i) {
                this.bv.put12(66, this.cw.newInteger((int)v2[i]).index);
            }
        }
        else if (value instanceof boolean[]) {
            ...
            for (int i = 0; i < v3.length; ++i) {
                this.bv.put12(90, this.cw.newInteger((int)(v3[i] ? 1 : 0)).index);
            }
        }
        else if (value instanceof short[]) {
            ...
            for (int i = 0; i < v4.length; ++i) {
                this.bv.put12(83, this.cw.newInteger((int)v4[i]).index);
            }
        }
            ...
            for (int i = 0; i < v5.length; ++i) {
                this.bv.put12(67, this.cw.newInteger((int)v5[i]).index);
            }
        }

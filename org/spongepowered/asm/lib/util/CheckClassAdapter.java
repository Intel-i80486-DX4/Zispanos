...
public class CheckClassAdapter extends ClassVisitor
{
    ...
    static void printAnalyzerResult(final MethodNode method, final Analyzer<BasicValue> a, final PrintWriter pw) {
        ...
        final TraceMethodVisitor mv = new TraceMethodVisitor((Printer)t);
    ...
    public FieldVisitor visitField(final int access, final String name, final String desc, final String signature, final Object value) {
        ...
        return (FieldVisitor)new CheckFieldAdapter(av);
    }
    ...
    public MethodVisitor visitMethod(final int access, final String name, final String desc, final String signature, final String[] exceptions) {
        ...
        if (this.checkDataFlow) {
            cma = new CheckMethodAdapter(access, name, desc, super.visitMethod(access, name, desc, signature, exceptions), (Map)this.labels);
        }
        else {
            cma = new CheckMethodAdapter(super.visitMethod(access, name, desc, signature, exceptions), (Map)this.labels);
        }
        cma.version = this.version;
        return (MethodVisitor)cma;
    }

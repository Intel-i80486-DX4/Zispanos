...
public class Analyzer<V extends Value> implements Opcodes
{
    ...
    public Frame<V>[] analyze(final String owner, final MethodNode m) throws AnalyzerException {
        ...
        for (int i = 0; i < m.tryCatchBlocks.size(); ++i) {
            ...
            final int begin = this.insns.indexOf((AbstractInsnNode)tcb.start);
            for (int end = this.insns.indexOf((AbstractInsnNode)tcb.end), j = begin; j < end; ++j) {
            ...
            try {
                ...
                if (insnType == 8 || insnType == 15 || insnType == 14) {
                    ...
                    if (insnNode instanceof JumpInsnNode) {
                        ...
                        final int jump = this.insns.indexOf((AbstractInsnNode)j2.label);
                        if (insnOpcode == 168) {
                ...
                for (int i3 = 0; i3 < insnHandlers2.size(); ++i3) {
                    ...
                    final int jump2 = this.insns.indexOf((AbstractInsnNode)tcb2.handler);
                ...
                throw new AnalyzerException(insnNode, "Error at instruction " + insn + ": " + e2.getMessage(), (Throwable)e2);
            }
        }
        return this.frames;
    }

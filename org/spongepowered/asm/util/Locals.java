...
public final class Locals
{
    ...
    public static List<LocalVariableNode> generateLocalVariableTable(final ClassNode classNode, final MethodNode method) {
        ...
        final Analyzer<BasicValue> analyzer = new Analyzer<BasicValue>((Interpreter<BasicValue>)new MixinVerifier(Type.getObjectType(classNode.name), objectType, (List)interfaces, false));
        try {

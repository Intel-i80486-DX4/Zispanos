    ...
    public enum DefaultUrlTypes implements UrlType
    {
        jarFile {
            ...
            public Dir createDir(final URL url) throws Exception {
                return (Dir)new ZipDir(new JarFile(Vfs.getFile(url)));
            }
        }, 
        jarUrl {
            @Override
            ...
            public Dir createDir(final URL url) throws Exception {
                try {
                    ...
                    if (urlConnection instanceof JarURLConnection) {
                        ...
                        return (Dir)new ZipDir(((JarURLConnection)urlConnection).getJarFile());
                    }
                }
                catch (Throwable t) {}
                final java.io.File file = Vfs.getFile(url);
                if (file != null) {
                    return (Dir)new ZipDir(new JarFile(file));
                }
                return null;
            }
        }, 

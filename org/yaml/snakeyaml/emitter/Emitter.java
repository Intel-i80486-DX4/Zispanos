...
public final class Emitter implements Emitable
{
    ...
    public Emitter(final Writer stream, final DumperOptions opts) {
        ...
        this.state = (EmitterState)new ExpectStreamStart();
    ...
    private void expectFlowSequence() throws IOException {
        ...
        this.state = (EmitterState)new ExpectFirstFlowSequenceItem();
    }
    ...
    private void expectFlowMapping() throws IOException {
        ...
        this.state = (EmitterState)new ExpectFirstFlowMappingKey();
    }
    
    private void expectBlockSequence() throws IOException {
        final boolean indentless = this.mappingContext && !this.indention;
        this.increaseIndent(false, indentless);
        this.state = (EmitterState)new ExpectFirstBlockSequenceItem();
    }
    
    private void expectBlockMapping() throws IOException {
        this.increaseIndent(false, false);
        this.state = (EmitterState)new ExpectFirstBlockMappingKey();
    }
    ...
    private boolean checkSimpleKey() {
        ...
        return length < this.maxSimpleKeyLength && (this.event instanceof AliasEvent || (this.event instanceof ScalarEvent && !this.analysis.empty && !this.analysis.multiline) || this.checkEmptySequence() || this.checkEmptyMapping());
    }
    ...
    private DumperOptions.ScalarStyle chooseScalarStyle() {
        ...
        if (ev.isPlain() && ev.getImplicit().canOmitTagInPlainScalar() && (!this.simpleKeyContext || (!this.analysis.empty && !this.analysis.multiline)) && ((this.flowLevel != 0 && this.analysis.allowFlowPlain) || (this.flowLevel == 0 && this.analysis.allowBlockPlain))) {
            return null;
        }
        ...
        for (int end = 0; end <= text.length(); ++end) {
            ...
            if (ch == null || "\"\\\u0085\u2028\u2029\ufeff".indexOf(ch) != -1 || ' ' > ch || ch > '~') {
                ...
                if (ch != null) {
                    ...
                    else if (!this.allowUnicode || !StreamReader.isPrintable((int)ch)) {
                        if (ch <= '\u00ff') {
    ...
    private class ExpectStreamStart implements EmitterState
    {
        public void expect() throws IOException {
            if (Emitter.this.event instanceof StreamStartEvent) {
                ...
                Emitter.this.state = (EmitterState)new ExpectFirstDocumentStart();
                return;
            }
    ...
    private class ExpectDocumentStart implements EmitterState
    {
        ...
        public void expect() throws IOException {
            if (Emitter.this.event instanceof DocumentStartEvent) {
                ...
                Emitter.this.state = (EmitterState)new ExpectDocumentRoot();
            }
            else {
                ...
                Emitter.this.state = (EmitterState)new ExpectNothing();
            }
        }
    }
    ...
    private class ExpectDocumentEnd implements EmitterState
    {
        public void expect() throws IOException {
            if (Emitter.this.event instanceof DocumentEndEvent) {
                ...
                Emitter.this.state = (EmitterState)new ExpectDocumentStart(false);
                return;
            }

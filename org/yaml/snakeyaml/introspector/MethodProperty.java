...
public class MethodProperty extends GenericProperty
{
    ...
    public List<Annotation> getAnnotations() {
        ...
        if (this.isReadable() && this.isWritable()) {
            annotations = (List<Annotation>)ArrayUtils.toUnmodifiableCompositeList((Object[])this.property.getReadMethod().getAnnotations(), (Object[])this.property.getWriteMethod().getAnnotations());
        }
        else if (this.isReadable()) {
            annotations = (List<Annotation>)ArrayUtils.toUnmodifiableList((Object[])this.property.getReadMethod().getAnnotations());
        }
        else {
            annotations = (List<Annotation>)ArrayUtils.toUnmodifiableList((Object[])this.property.getWriteMethod().getAnnotations());
        }
        return annotations;
    }

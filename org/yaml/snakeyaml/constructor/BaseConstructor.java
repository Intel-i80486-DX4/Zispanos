...
public abstract class BaseConstructor
{
    ...
    public BaseConstructor() {
        ...
        this.typeDefinitions.put(SortedMap.class, new TypeDescription((Class)SortedMap.class, Tag.OMAP, (Class)TreeMap.class));
        this.typeDefinitions.put(SortedSet.class, new TypeDescription((Class)SortedSet.class, Tag.SET, (Class)TreeSet.class));
    }
    ...
    public Object getSingleData(final Class<?> type) {
        ...
        if (node != null && !Tag.NULL.equals((Object)node.getTag())) {
            if (Object.class != type) {
                node.setTag(new Tag((Class)type));
            }
    ...
    protected Set<Object> newSet(final CollectionNode<?> node) {
        try {
            return (Set<Object>)this.newInstance(Set.class, (Node)node);
        }
        catch (InstantiationException e) {
    ...
    protected List<Object> newList(final SequenceNode node) {
        try {
            return (List<Object>)this.newInstance(List.class, (Node)node);
        }
        catch (InstantiationException e) {
    ...
    protected Map<Object, Object> newMap(final MappingNode node) {
        try {
            return (Map<Object, Object>)this.newInstance(Map.class, (Node)node);
        }
        catch (InstantiationException e) {
    ...
    protected Set<?> constructSet(final SequenceNode node) {
        final Set<Object> result = this.newSet((CollectionNode<?>)node);
        this.constructSequenceStep2(node, result);
        return result;
    }
    ...
    protected Object constructArrayStep2(final SequenceNode node, final Object array) {
        final Class<?> componentType = (Class<?>)node.getType().getComponentType();
        int index = 0;
        for (final Node child : node.getValue()) {
            if (child.getType() == Object.class) {
                child.setType((Class)componentType);
            }
    ...
    protected Set<Object> constructSet(final MappingNode node) {
        final Set<Object> set = this.newSet((CollectionNode<?>)node);
